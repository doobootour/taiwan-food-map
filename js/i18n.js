...
const I18N = {
  ko: {
    ...
    nav_map: "지도 보기",
    nav_blog: "블로그",
    blog_hero_eyebrow: "Taiwan Travel Guide",
    blog_hero_title: "블로그",
    blog_hero_sub: "교통, 선물, 맛집까지 — 대만 여행 전반에 도움되는 정보를 실제 여행자들의 경험을 바탕으로 정리해요.",
    nav_profile: "마이페이지",
    nav_community: "커뮤니티",
  ...
  en: {
    ...
    blog_hero_sub: "Transportation, souvenirs, restaurants and more — practical info for your whole Taiwan trip, based on real traveler experience.",
    nav_profile: "My Page",
