...
const I18N = {
  ko: {
    ...
    nav_map: "지도 보기",
    nav_blog: "블로그",
    blog_hero_eyebrow: "Taiwan Food Stories",
    blog_hero_title: "블로그",
    blog_hero_sub: "대만 맛집의 역사와 이야기, 그리고 실제로 다녀온 여행자들의 후기를 모았어요.",
    nav_profile: "마이페이지",
    nav_community: "커뮤니티",
    ...
    sec_categories_desc: "31가지 카테고리에서 골라 지도 위 맛집을 확인하고, 내 주변 맛집도 찾아보세요. 다녀온 곳이 정말 좋았다면 핀을 눌러 전 세계 여행자들에게 추천해 주세요.",
  ...
  en: {
    ...
    blog_hero_sub: "Stories behind Taiwan's food scene, and real reviews from travelers who've actually been.",
    nav_profile: "My Page",
    ...
    sec_categories_desc: "Pick from 31 categories to find spots on the map, or search near you. Found a hidden gem of your own? Tap a pin and recommend it to fellow travelers worldwide.",
