...
const BLOG_LIST = [
  {
    ...
    ko: {
      ...
      desc: "이동 난이도, 관광 밀도, 부모님 동선까지 — 세 도시를 비교해서 첫 대만 여행지를 골라봤어요.",
      meta: "대만 여행 · 도시 비교",
    },
    en: {
...
const BLOG_POSTS = {
  "taipei-taichung-kaohsiung-with-mom": {
    ...
    ko: {
      ...
      metaDescription: "부모님과 함께하는 첫 대만 여행, 어느 도시가 좋을까요? 이동 난이도·관광 밀도·부모님 동선 관점에서 타이베이·타이중·가오슝을 비교했어요.",
      ogTitle: "타이베이·타이중·가오슝, 엄마와 가는 첫 대만 여행 어디가 편할까",
      eyebrow: "대만 여행 가이드 · 도시 선택",
      title: "타이베이·타이중·가오슝, 엄마와 가는 첫 대만 여행 어디가 편할까",
      dek: "이동 수단, 볼거리 밀도, 그리고 무엇보다 부모님이 걷기 편한 동선까지 — 세 도시를 나란히 비교해서 첫 대만 여행지를 골라봤어요.",
      metaAuthor: "나만 알고 싶은 대만 맛집 편집팀",
      metaTopic: "대만 여행 · 도시 비교",
      metaReadTime: "약 7분 소요",
      intro: "부모님을 모시고 떠나는 첫 대만 여행이라면 도시 선택부터 고민이 깊어져요. <strong>타이베이</strong>는 두말할 것 없이 기본값이지만, 일정이 며칠 더 남는다면 <strong>타이중</strong>과 <strong>가오슝</strong> 중 어디를 더할지가 관건이에요. 이동 난이도, 관광 밀도, 그리고 무엇보다 부모님이 걷고 이동하기에 편한 동선까지 — 세 가지 기준으로 비교해봤어요.",
      blocks: [
        { type: "h2", text: "01 · 세 도시, 한눈에 비교하기" },
        {
          ...
          cities: ["타이베이", "타이중", "가오슝"],
          rows: [
            { label: "이동 난이도", values: ["MRT 노선이 촘촘해서 도보 이동이 거의 없어요", "버스 의존도가 높고 MRT가 주요 관광지를 비껴가는 구간이 많아요", "MRT와 경전철(LRT)로 주요 명소를 대부분 커버해요"] },
            { label: "관광 밀도", values: ["도보 반경 안에 명소가 밀집해 있어요", "명소보다는 카페·맛집 위주로 넓게 퍼져 있어요", "바닷가·야시장 등 명소가 적당한 간격으로 분산돼 있어요"] },
            { label: "부모님 동선", values: ["역에서 도보 5~10분 이내 명소가 많아 무난해요", "걷는 구간이 길어지기 쉬워 택시 이용을 고려해야 해요", "역 인근으로 동선을 짜기가 비교적 쉬워요"] },
            { label: "근교 확장성", values: ["타오위안, 이란 방면", "일월담·칭징농장·허환산으로 가는 전초기지로 좋아요", "타이난·컨딩·샤오류치우를 묶는 남부투어가 가능해요"] },
          ],
        },
        {
          type: "cityGrid",
          items: [
            { img: "assets/images/regions/taipei.webp", name: "타이베이", tag: "고민 없는 기본값", desc: "MRT 한 장이면 웬만한 명소는 다 닿아요. 첫 대만 여행이라면 가장 무난한 선택." },
            { img: "assets/images/regions/taichung.webp", name: "타이중", tag: "미식·도시 감성", desc: "미슐랭 맛집과 미술관·오페라하우스가 많지만, 교통은 상대적으로 불편해요." },
            { img: "assets/images/regions/kaohsiung.webp", name: "가오슝", tag: "타이베이 다음으로 무난한 선택", desc: "바다가 있고 대중교통이 편해서, 남부 일정을 짜기에도 가장 수월해요." },
          ],
        },
        { type: "h2", text: "02 · 타이베이 — 고민 없는 기본값" },
        { type: "p", html: "타이베이는 대만 여행의 정답에 가까워요. 지하철(MRT) 노선이 시내 전역을 촘촘히 연결하고, 역에서 내려 조금만 걸으면 고궁박물원, 스린 야시장, 융캉제 같은 대표 명소에 닿아요. 부모님과 함께라면 이동 스트레스가 적다는 것만으로도 큰 장점이에요. 처음 대만을 찾는다면, 혹은 일정이 나흘 이하로 짧다면 타이베이 한 도시에만 집중하는 편이 오히려 여행을 편안하게 만들어요." },
        { type: "h2", text: "03 · 가오슝 — 타이베이 다음으로 가장 무난한 선택" },
        { type: "p", html: "가오슝은 한국으로 치면 부산에 가까워요. 서울(타이베이) 다음으로 부산(가오슝)을 찾는 것처럼, 대만 여행에서도 타이베이 다음 도시로 가장 많이 떠올리는 곳이에요. MRT와 경전철(LRT)이 주요 명소 대부분을 커버하고, 바닷가와 야시장이 가까이 있어 동선을 짜기 쉬워요. 일정이 길다면 타이난, 컨딩, 샤오류치우까지 묶어 남부 투어로 확장할 수 있는 거점이기도 해요." },
        { type: "h2", text: "04 · 타이중 — 미식·도시 감성은 좋지만 동선은 고려해야" },
        { type: "p", html: "타이중은 관광지보다는 '그냥 도시'에 가까운 매력이 있어요. 미슐랭 맛집이 곳곳에 있고, 박물관·미술관·오페라하우스를 돌아보며 도시 감성을 느끼기 좋아요. 다만 버스는 배차나 정류장 위치가 여행자에게 낯설 수 있고, MRT는 정작 관광지를 비껴가는 구간이 많아 걷는 거리가 길어지기 쉬워요. 대전과 자주 비교되는 이유이기도 해요 — 딱히 관광명소가 몰려 있진 않지만 맛집 투어로는 훌륭한 도시라는 점에서요. 부모님과 함께라면 택시나 차량 이동을 적극적으로 활용하는 게 좋아요." },
        { type: "h2", text: "05 · 엄마와 함께라면, 이렇게 골라보세요" },
        {
          type: "tipList",
          items: [
            { mark: "첫", b: "첫 대만 여행 + 일정 4일 이하", desc: "타이베이 한 도시에 집중하는 게 가장 편해요. 이동 스트레스가 없어야 부모님도 여행을 온전히 즐길 수 있어요." },
            { mark: "남", b: "타이베이 + 도시 하나 추가, 이동 편의가 우선", desc: "가오슝을 추천해요. MRT·LRT로 동선이 짧고, 타이난·컨딩 등 근교 일정도 짜기 쉬워요." },
            { mark: "미", b: "미식 여행 + 며칠 여유, 도보는 어느 정도 괜찮음", desc: "타이중을 더해보세요. 미슐랭 맛집과 한적한 도시 분위기를 느낄 수 있지만, 택시 이동을 적극 활용하는 게 좋아요." },
          ],
        },
        { type: "quote", text: "\"타이중이 대전이라면, 가오슝은 부산.\" — 여행자들 사이에서 자주 나오는 비유예요. 목적에 맞게 고르면 후회가 없어요." },
    ...
    en: {
      ...
      blocks: [
        ...
        },
        {
          type: "cityGrid",
          items: [
            { img: "assets/images/regions/taipei.webp", name: "Taipei", tag: "The easy default", desc: "One MRT card gets you almost everywhere. The safest choice for a first Taiwan trip." },
            { img: "assets/images/regions/taichung.webp", name: "Taichung", tag: "Food & city vibes", desc: "Plenty of Michelin restaurants, museums, and an opera house — but transit is relatively inconvenient." },
            { img: "assets/images/regions/kaohsiung.webp", name: "Kaohsiung", tag: "The easiest second city", desc: "Coastal, with convenient public transit — also the easiest base for a southern-Taiwan itinerary." },
          ],
        },
  ...
  "taipei-easycard-transport-guide": {
    ...
    ko: {
      ...
      metaDescription: "타이베이 첫 여행, 이지카드만으로 충분할까요? 신용카드 컨택리스 결제, 버스, 택시(우버)는 언제 타야 하는지까지 — 실제 여행자들의 경험을 바탕으로 정리했어요.",
      ogTitle: "타이베이 첫 여행 3박4일, 이지카드만으로 충분할까?",
      eyebrow: "타이베이 여행 가이드 · 교통",
      title: "타이베이 첫 여행 3박4일, 이지카드만으로 충분할까?",
      dek: "이지카드 하나로 지하철·버스·편의점까지 다 되는지, 신용카드는 어디까지 되는지, 택시는 언제 타야 하는지 — 첫 타이베이 여행자들이 가장 많이 묻는 교통 고민을 정리했어요.",
      metaAuthor: "나만 알고 싶은 대만 맛집 편집팀",
      metaTopic: "타이베이 · 교통 가이드",
      metaReadTime: "약 6분 소요",
      intro: "타이베이 여행을 준비하다 보면 꼭 한 번은 마주치는 질문이 있어요. \"이지카드 하나로 충분할까? 신용카드도 되나? 택시는 언제 타야 하지?\" 대중교통이 촘촘한 타이베이는 사실 복잡하게 고민할 필요가 없는 도시예요. 실제 여행자들의 경험을 바탕으로 <strong>이지카드·신용카드·택시(우버)</strong>의 사용 범위를 한 번에 정리해봤어요.",
      blocks: [
        { type: "h2", text: "01 · 이지카드 vs 신용카드, 어디까지 될까" },
        {
          ...
          rows: [
            { label: "지하철(MRT)", values: ["가능 — 공항철도 포함 전 노선", "가능 — 카드 뒷면에 컨택리스 결제 아이콘이 있어야 해요", "필요할 때만 이용"] },
            ...
            { label: "첫 여행자 추천도", values: ["대중교통 위주라면 필수", "카드 결제를 선호한다면 보조 수단으로 좋아요", "체력이 떨어지거나 짐이 많을 때만"] },
          ],
        },
        { type: "h2", text: "02 · 유명 관광지는 거의 다 지하철·버스로 닿아요" },
        { type: "p", html: "타이베이는 유명 관광지 대부분이 MRT 노선과 버스 노선으로 커버돼요. 고궁박물원, 스린 야시장, 융캉제, 시먼딩처럼 여행자들이 많이 찾는 코스는 이지카드 한 장이면 충분히 다닐 수 있어요. 구글 지도로 경로를 검색하면 지하철·버스 환승 정보는 물론 버스 하차 알림까지 챙겨주기 때문에, 초행길이라도 크게 헤맬 일이 없어요." },
        { type: "h2", text: "03 · 택시(우버)는 언제 타야 할까" },
        {
          type: "tipList",
          items: [
            { mark: "1", b: "체력이 떨어졌을 때", desc: "하루 종일 걸어다닌 뒤 숙소로 돌아갈 때는, 무리해서 대중교통을 갈아타기보다 택시가 훨씬 편해요." },
            { mark: "2", b: "쇼핑으로 짐이 많아질 때", desc: "양손 가득 짐을 들고 환승하기보다, 숙소까지 바로 이동하는 편이 나아요." },
            { mark: "3", b: "대중교통 환승이 애매할 때", desc: "노선이 꼬이거나 도보 이동이 길어지는 구간이라면, 택시가 시간과 체력을 아껴줘요." },
          ],
        },
        { type: "h2", text: "04 · 3박4일, 실제로는 이렇게 다녀요" },
        { type: "p", html: "실제로 다녀온 여행자들의 후기를 보면 답은 비슷해요. 3박4일 내내 지하철과 버스만으로 다녔다는 후기가 가장 많았고, 컨택리스 신용카드 한 장으로 대만에서 6일을 지내고 온 사례도 있었어요. 이지카드는 남은 잔액을 편의점에서 알뜰하게 쓰고 귀국하는 것도 흔한 방법이에요. 우버 앱은 다들 미리 설치해두지만, 실제로 타는 일은 드물다는 의견이 많았어요." },
        { type: "quote", text: "\"걷는 게 괜찮으시다면 지하철로 움직이셔도 어지간하면 충분합니다.\" — 실제 타이베이를 다녀온 여행자들이 가장 많이 남긴 한마디예요." },
        { type: "h2", text: "05 · 첫 여행자를 위한 체크리스트" },
        {
          type: "tipList",
          items: [
            { mark: "✓", b: "이지카드부터 챙기기", desc: "공항 도착 후 지하철역이나 편의점에서 바로 구매·충전할 수 있어요. 지하철, 버스, 편의점까지 한 장으로 해결돼요." },
            { mark: "✓", b: "구글 지도 앱 미리 준비", desc: "노선 검색은 물론 버스 하차 알림까지 챙겨주니, 초행길에 특히 유용해요." },
            { mark: "✓", b: "우버 앱은 미리 설치만 해두기", desc: "실제로 탈 일은 많지 않아도, 짐이 많거나 체력이 떨어졌을 때를 대비해 미리 설치해두면 마음이 편해요." },
            { mark: "✓", b: "컨택리스 신용카드 확인", desc: "카드 뒷면에 와이파이 모양(옆으로 누운) 아이콘이 있다면 지하철 결제가 가능해요. 다만 버스는 아직 지원하지 않아요." },
          ],
        },
